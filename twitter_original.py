...
if __name__ == "__main__":
    ...
    rel_tweets = tweets_from_relevant_usernames(5, file_path = "C:\\Users\\shawn\\Desktop\\MIT college work\\17.835\\Final Project\\Twitter_Data\\usernames.csv", usernames=None)
    print(rel_tweets)
